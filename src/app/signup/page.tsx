    ...
    <div className="flex min-h-dvh">
      ...
      <div className="flex flex-1 flex-col justify-center px-6 sm:px-12 lg:px-20">
        <div className="mx-auto w-full max-w-[380px]">
          ...
          <motion.h1 custom={2} initial="hidden" animate="visible" variants={fadeIn} className="mt-5 font-[family-name:var(--font-display)] text-[26px] font-bold tracking-tight">Create account</motion.h1>
          <motion.p custom={3} initial="hidden" animate="visible" variants={fadeIn} className="mt-1.5 text-sm text-neutral-500">Start building smart intake forms for your business.</motion.p>
